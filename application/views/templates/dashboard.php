...
<head>
    ...
    <title><?= $title; ?> | Aplikasi Sistem Informasi Barang</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">SMKN1TPU</div>
            </a>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; POLITEKNIK PERTANIAN NEGERI SAMARINDA
                            <span>&copy; PROGRAM STUDI TEKNOLOGI REKAYASA PERANGKAT LUNAK ANGKATAN 2017
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
